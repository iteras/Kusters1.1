...
namespace Web.Controllers
{
    ...
    public class ContactsController : BaseController
    {
        ...
        public ActionResult Create()
        {
            ...
            vm.PersonSelectList = new SelectList(_uow.Persons.GetAllForUser(User.Identity.GetUserId<int>()), nameof(Person.PersonId));
            return View(vm);
        }
        ...
        public ActionResult Create(ContactCreateEditViewModel vm)
        {
            ...
            vm.PersonSelectList = new SelectList(_uow.Persons.GetAllForUser(User.Identity.GetUserId<int>()), nameof(Person.PersonId), "Changed, before lastFirstname", vm.Contact.PersonId);
            return View(vm);
        }
        ...
        public ActionResult Edit(ContactCreateEditViewModel vm)
        {
            ...
            vm.ContactTypeSelectList = new SelectList(_uow.ContactTypes.All.Select(t => new { t.ContactTypeId, ContactTypeName = t.ContactTypeName.Translate() }).ToList(), nameof(ContactType.ContactTypeId), nameof(ContactType.ContactTypeName), vm.Contact.ContactTypeId);
           // vm.PersonSelectList = new SelectList(_uow.Persons.GetAllForUser(User.Identity.GetUserId<int>()), vm.Contact.PersonId);
            return View(vm);
        }
