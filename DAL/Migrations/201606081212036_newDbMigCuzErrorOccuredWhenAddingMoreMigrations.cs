namespace DAL.Migrations
{
    ...
    public partial class newDbMigCuzErrorOccuredWhenAddingMoreMigrations : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        TelNr = c.String(nullable: false, maxLength: 20),
                        BankNr = c.String(nullable: false, maxLength: 64),
                ...
                c => new
                    {
                        ...
                        YoutubeVideoId = c.String(nullable: false, maxLength: 20),
                ...
                c => new
                    {
                        ...
                        PlaylistName = c.String(nullable: false, maxLength: 64),
                        YoutubeVideoId = c.String(nullable: false, maxLength: 20),
                        UserIntId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.PlaylistId)
                .ForeignKey("dbo.UserInt", t => t.UserIntId)
                .Index(t => t.UserIntId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Playlist", "UserIntId", "dbo.UserInt");
            ...
            DropIndex("dbo.Playlist", new[] { "UserIntId" });
