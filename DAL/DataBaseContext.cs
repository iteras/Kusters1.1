...
namespace DAL
{
    public class DataBaseContext : DbContext, IDbContext
    {
        ...
        public IDbSet<ChatInPretension> ChatInPretensions { get; set; }
        public IDbSet<Contract> Contracts { get; set; }
        public IDbSet<DealInCampaign> DealInCampaigns { get; set; }
        public IDbSet<DealInContract> DealInContracts { get; set; }
        public IDbSet<Description> Descriptions { get; set; }
        public IDbSet<PersonInChat> PersonInChats { get; set; }
        public IDbSet<PersonInDeal> PersonInDeals { get; set; }
        public IDbSet<PersonInContract> PersonInContracts { get; set; }
        public IDbSet<PersonInPretension> PersonInPretensions { get; set; }
